#!/bin/bash
#******************************************************************************
# ZYNTHIAN PROJECT: Setup Zynthian Plugins from scratch for RBPix86_64
# 
...
$ZYNTHIAN_RECIPE_DIR/install_monique_monosynth.sh
#-#$ZYNTHIAN_RECIPE_DIR/install_odin2_prebuilt.sh
$ZYNTHIAN_RECIPE_DIR/install_odin2.sh
